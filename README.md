# PlotBB
![Latest Release](https://img.shields.io/github/v/release/adawiiii/plotbb) [![PyPi](https://img.shields.io/pypi/v/plotbb?cacheBust=0.9.3)](https://pypi.org/project/plotbb/)
